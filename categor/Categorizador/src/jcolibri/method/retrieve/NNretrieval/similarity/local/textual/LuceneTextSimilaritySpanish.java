 ...
 */
public class LuceneTextSimilaritySpanish extends InContextLocalSimilarityFunction
{
     ...
     */
    public LuceneTextSimilaritySpanish(LuceneIndexSpanish index, CBRQuery query, Attribute at, boolean normalized)
    {
	...
	lsr = LuceneSearcher.searchSpanish(index, qs.toString(), sf);
