 ...
 *
 */
public class TextStemmerSpanish
{
    static Stemmer stemmer = new Stemmer(Language.SPANISH);
    ...
    {
	org.apache.commons.logging.LogFactory.getLog(TextStemmerSpanish.class).info("Stemming text.");
	ProgressController.init(TextStemmerSpanish.class, "Stemming text...", cases.size());
	for(CBRCase c: cases)
	{
