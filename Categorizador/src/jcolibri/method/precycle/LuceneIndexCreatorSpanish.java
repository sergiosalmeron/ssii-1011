/**
 * LuceneIndexCreatorSpanish.java
 * jCOLIBRI2 framework. 
 ...
 */
public class LuceneIndexCreatorSpanish {
	 ...
	 */
	public static LuceneIndexSpanish createLuceneIndex(CBRCaseBase casebase, Collection<Attribute> fields)
	{
		...
		{	
			...
			{
				org.apache.commons.logging.LogFactory.getLog(LuceneIndexCreatorSpanish.class).error("Field "+field+" is not an jcolibri.datatyps.Text. Aborting Lucene index creation");
				return null;
			}
		}
		...
		return new LuceneIndexSpanish(docs);
	 ...
	 * The name and content of the Lucene document field is the name and content of the attribute.
	 */
	public static LuceneIndexSpanish createLuceneIndex(CBRCaseBase casebase)
	{
